...
int main(void)
{
  ...
  /* USER CODE BEGIN WHILE */
	while (1) {
		...
		convFreq2Multiples(); // Turns Hz into KHz, MHz or GHz
		sprintf(buffer, "### Frequency Genearator (Timer 3) ###\n\r"
				...
				"Frequency: %s\n\r\n\r", bufferGenFreq,
				PSC, ARR, CCR, (CCR / (float) ARR) * 100.0, bufferTimerClock,
				currentCCR, lastCCR, periodPrint, bufferFreq);
